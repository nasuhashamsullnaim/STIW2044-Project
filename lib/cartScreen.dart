...
class _CartScreenState extends State<CartScreen> {
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: ClipOval(
                                            ...
                                            imageUrl:
                                                "https://itsmelele.com/DeafZone3/assets/images/books/${cartData[index]['image']}.jpg",
  ...
  void _loadCart() {
    ...
    pr.show();
    String urlLoadJobs = "https://itsmelele.com/DeafZone3/php/loadCart.php";
  ...
  _updateCart(int index, String op) {
    ...
    String urlLoadJobs = "https://itsmelele.com/DeafZone3/php/updateCart.php";
    http.post(urlLoadJobs, body: {
      "email": widget.user.email,
      "bookid": cartData[index]['bookid'],
        ...
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
                ...
                http.post("https://itsmelele.com/DeafZone3/php/deleteCart.php",
                    body: {
                      "email": widget.user.email,
                      "bookid": cartData[index]['bookid'],
                    }).then((res) {
  ...
  Future<void> _payusingstorecredit(double newamount) async {
    ...
    pr.style(message: "Updating cart...");
    pr.show();
    String urlPayment = "https://itsmelele.com/DeafZone3/php/paymentsc.php";
